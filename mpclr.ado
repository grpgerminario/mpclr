program mpclr, eclass properties(svyb)
	version 10.0
	#delimit ;
	syntax varlist (min=2 max=2 fv) [if] [in] [pw iw],  YMIN(string) YMAX(string) [BOUNDS(string) NMTS NMTR MIV(varname) MIVBOUNDS(string) bins(integer 5) NMIV moret(numlist) mores(numlist) reps(integer 25) seed(integer 22176) level(integer 95) NOISYCLR LATEX(string) NPSU(int -1) SURVEY UNCORRECTED];
	marksample touse;
	#delimit cr
			...
			foreach a of local asmpt {
				forval t=`subminT'/`maxT' {
					foreach x of local lowup {
						...
						svy bootstrap _b, saving(`cosa_`x'_`t'_`a''.dta, double replace) noheader notable:  mpbounds `y' `T' if `touse', ymin(`ymin') ymax(`ymax') `nmts' `nmtr' moret(`moret') mores(`mores') ul(`x') contrt(`t') contrs(`k') asmptn(`a')
				...
				if "`moret'" != "" {
					forval i=1/`conta' {
						foreach x of local lowup {
							...
							svy bootstrap _b, saving(`cosam_`x'_`i'_`a''.dta, double replace) noheader notable:  mpbounds `y' `T' if `touse', ymin(`ymin') ymax(`ymax') `nmts' `nmtr' moret(`moret') mores(`mores') ul(`x') contrt(`t`i'') contrs(`s`i'') asmptn(`a') 
			...
			foreach a of local asmpt {
				forval t=`subminT'/`maxT' {
					foreach x of local lowup {
						...
						bootstrap _b, reps(`reps') seed(`seed') saving(`cosa_`x'_`t'_`a''.dta, double replace) noheader notable:  mpbounds `y' `T' if `touse', ymin(`ymin') ymax(`ymax') `nmts' `nmtr' moret(`moret') mores(`mores') ul(`x') contrt(`t') contrs(`k') asmptn(`a')
				...
				if "`moret'" != "" {
					forval i=1/`conta' {
						foreach x of local lowup {
							...
							bootstrap _b, reps(`reps') seed(`seed') saving(`cosam_`x'_`i'_`a''.dta, double replace) noheader notable:  mpbounds `y' `T' if `touse', ymin(`ymin') ymax(`ymax') `nmts' `nmtr' moret(`moret') mores(`mores') ul(`x') contrt(`t`i'') contrs(`s`i'') asmptn(`a')
			...
			foreach a of local asmpt {
				forval t=`subminT'/`maxT' {
					foreach x of local lowup {
						...
						svy bootstrap _b, saving(`cosav_`x'_`t'_`a''.dta, double replace) noheader notable:  mpbounds `y' `T' if `touse', ymin(`ymin') ymax(`ymax') `nmts' `nmtr' miv(`miv') bins(`bins') `nmiv' moret(`moret') mores(`mores') ul(`x') contrt(`t') contrs(`k') asmptn(`a') 
				...
				if "`moret'" != "" {
					forval i=1/`conta' {
						foreach x of local lowup {
							...
							svy bootstrap _b, saving(`cosavm_`x'_`i'_`a''.dta, double replace) noheader notable:  mpbounds `y' `T' if `touse', ymin(`ymin') ymax(`ymax') `nmts' `nmtr' miv(`miv') bins(`bins') `nmiv' moret(`moret') mores(`mores') ul(`x') contrt(`t`i'') contrs(`s`i'') asmptn(`a') 
			...
			foreach a of local asmpt {
				forval t=`subminT'/`maxT' {
					foreach x of local lowup {
						...
						bootstrap _b, reps(`reps') seed(`seed') saving(`cosav_`x'_`t'_`a''.dta, double replace) noheader notable:  mpbounds `y' `T' if `touse', ymin(`ymin') ymax(`ymax') `nmts' `nmtr' miv(`miv') bins(`bins') `nmiv' moret(`moret') mores(`mores') ul(`x') contrt(`t') contrs(`k') asmptn(`a')
				...
				if "`moret'" != "" {
					forval i=1/`conta' {
						foreach x of local lowup {
							...
							bootstrap _b, reps(`reps') seed(`seed') saving(`cosavm_`x'_`i'_`a''.dta, double replace) noheader notable:  mpbounds `y' `T' if `touse', ymin(`ymin') ymax(`ymax') `nmts' `nmtr' miv(`miv') bins(`bins') `nmiv' moret(`moret') mores(`mores') ul(`x') contrt(`t`i'') contrs(`s`i'') asmptn(`a')
